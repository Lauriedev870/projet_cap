import{j as e,r as a}from"./index-YVm0Ihmo.js";import{P as C}from"./PageTitle-DGmVOS_X.js";import{S as b}from"./SectionTitle-BpvSolx0.js";import{g as A,f as k}from"./administrationService-Be9c5m75.js";import{a as P}from"./api-CsT-jl7v.js";const S=async t=>(await P.get("/api/stockage/documents")).data,D=()=>e.jsx("div",{className:"container","data-aos":"fade-up","data-aos-delay":"100",children:e.jsxs("div",{className:"row align-items-center",children:[e.jsx("div",{className:"col-lg-6","data-aos":"fade-up","data-aos-delay":"200",children:e.jsx("img",{src:"/assets/img/education/cap-bat.png",alt:"À propos du CAP",className:"img-fluid rounded-4"})}),e.jsx("div",{className:"col-lg-6","data-aos":"fade-up","data-aos-delay":"300",children:e.jsxs("div",{className:"about-content",children:[e.jsx("span",{className:"subtitle",children:"À propos du CAP"}),e.jsx("h2",{children:"Former les Leaders de Demain par une Éducation d'Excellence"}),e.jsx("p",{children:"Le Centre Autonome de Perfectionnement (CAP) est une institution d'enseignement supérieur de référence, engagée à fournir une formation académique et professionnelle de qualité. Nous préparons nos étudiants à relever les défis du monde moderne avec compétence et confiance."}),e.jsxs("div",{className:"stats-row",children:[e.jsxs("div",{className:"stats-item",children:[e.jsx("span",{className:"count",children:"15"}),e.jsx("p",{children:"Années d'Expérience"})]}),e.jsxs("div",{className:"stats-item",children:[e.jsx("span",{className:"count",children:"200+"}),e.jsx("p",{children:"Enseignants Experts"})]}),e.jsxs("div",{className:"stats-item",children:[e.jsx("span",{className:"count",children:"50k+"}),e.jsx("p",{children:"Étudiants Formés"})]})]})]})})]})}),q=({administrateur:t,delay:u})=>e.jsx("div",{className:"col-xl-3 col-lg-4 col-md-6","data-aos":"fade-up","data-aos-delay":u,children:e.jsxs("div",{className:"administration-card card border-0 shadow-sm h-100",children:[e.jsxs("div",{className:"card-image position-relative",children:[e.jsx("img",{src:t.image,className:"card-img-top",alt:t.nom,style:{height:"280px",objectFit:"cover"}}),e.jsx("div",{className:"position-absolute top-0 start-0 m-3",children:e.jsx("div",{className:"bg-primary text-white rounded-circle d-flex align-items-center justify-content-center",style:{width:"40px",height:"40px",fontSize:"0.9rem",fontWeight:"bold"},children:t.ordre})})]}),e.jsxs("div",{className:"card-body d-flex flex-column",children:[e.jsxs("div",{children:[e.jsx("h5",{className:"card-title fw-bold text-dark",children:t.nom}),e.jsx("p",{className:"text-primary fw-semibold",children:t.poste})]}),e.jsx("div",{className:"",children:e.jsxs("div",{className:"contact-info",children:[t.email&&e.jsxs("div",{className:"d-flex align-items-center mb-2",children:[e.jsx("i",{className:"bi bi-envelope text-muted me-2"}),e.jsx("small",{className:"text-muted",children:t.email})]}),t.telephone&&e.jsxs("div",{className:"d-flex align-items-center",children:[e.jsx("i",{className:"bi bi-telephone text-muted me-2"}),e.jsx("small",{className:"text-muted",children:t.telephone})]})]})})]})]})}),F=()=>{const[t,u]=a.useState([]),[c,x]=a.useState(!0),[o,g]=a.useState(null);return a.useEffect(()=>{(async()=>{try{x(!0);const n=(await A()).map(k),h={"Chef du CAP":1,"Chef de Division":2,Comptable:3,Secrétaire:4};n.sort((l,p)=>{const m=h[l.poste]||999,j=h[p.poste]||999;return m-j}),u(n)}catch(d){console.error("Erreur chargement administration:",d),g("Impossible de charger les membres de l'administration")}finally{x(!1)}})()},[]),e.jsx("section",{id:"administration",className:"administration section bg-light",children:e.jsxs("div",{className:"container",children:[e.jsx(b,{title:"Notre Équipe Administrative",subtitle:"Découvrez les membres de l'administration qui œuvrent au quotidien pour l'excellence du CAP"}),c&&e.jsxs("div",{className:"text-center py-5",children:[e.jsx("div",{className:"spinner-border text-primary",role:"status",children:e.jsx("span",{className:"visually-hidden",children:"Chargement..."})}),e.jsx("p",{className:"mt-3 text-muted",children:"Chargement de l'équipe administrative..."})]}),o&&e.jsx("div",{className:"alert alert-warning text-center",role:"alert",children:o}),!c&&!o&&e.jsx("div",{className:"row g-4 justify-content-start",children:t.map((r,d)=>e.jsx(q,{administrateur:r,delay:200+d*100},r.id))}),e.jsx("style",{children:`
      ...
      `})]})},U=()=>e.jsxs(e.Fragment,{children:[e.jsx(C,{title:"À propos",breadcrumbs:[{label:"Accueil",path:"/"},{label:"À propos"}]}),e.jsxs("section",{id:"about",className:"about section",children:[e.jsx(D,{}),e.jsx(F,{}),e.jsx(T,{})]})]});export{U as default};
